...
namespace ThreeInRaw
{
    class FinalScreen
    {
        ...
        public FinalScreen()
        {
            ...
            this.buttonPos = new int[4] { pos[0]+45, pos[1]+180, 185, 40 };
            ...
            this.buttonText = new Text("На главную", font);
            ...
            this.pointsText.Position = new SFML.System.Vector2f(pos[0]+45, pos[1]+85);
        ...
        {
            this.pointsText.DisplayedString = "Вы набрали "+points+" очков";
        }
    }
}
